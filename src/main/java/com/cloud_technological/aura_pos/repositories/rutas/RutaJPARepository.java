...
public interface RutaJPARepository extends JpaRepository<RutaEntity, Long> {
    ...
    List<RutaEntity> findByVendedorIdAndActivoTrue(Long vendedorId);
    Optional<RutaEntity> findByVendedorIdAndDiaSemanaAndActivoTrue(Long vendedorId, Integer diaSemana);
    List<RutaEntity> findByEmpresaIdAndActivoTrueOrderByDiaSemanaAsc(Long empresaId);
}