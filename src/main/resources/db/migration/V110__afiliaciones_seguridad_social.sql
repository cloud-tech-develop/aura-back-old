...
-- ═══════════════════════════════════════════════════════════════════════════
-- VALIDACIONES EN APLICACIÓN (no se pueden hacer con CHECK)
--
--  1. El tercero referenciado desde contrato_afiliacion debe tener el ROL
--     correspondiente: tipo='EPS' → tercero_rol con rol='EPS'.
--
--  2. Ese tercero debe tener entidad_seguridad_social_id poblado. Sin eso,
--     PILA no resuelve el código y el archivo sale incompleto.
--     VALIDAR AL GUARDAR LA AFILIACIÓN, no al generar la planilla — si no,
--     el error aparece a fin de mes con 200 empleados.
--
--  3. Un contrato activo debería tener las 4 afiliaciones (EPS, AFP, CCF, ARL).
--     Advertir al liquidar si falta alguna.
--
-- PENDIENTES QUE ESTO DESTRABA / NECESITA
--   · #8: ¿tarifa ARL por contrato o por centro de trabajo? Se dejaron ambos
--     caminos; elegir uno y quitar el otro.
--   · #9: ¿quién mantiene el catálogo nacional? Recomendación: nosotros.
--     Poblar entidad_seguridad_social con los códigos vigentes del operador.
-- ═══════════════════════════════════════════════════════════════════════════
